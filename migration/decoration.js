...
// Load Excel file
const filePath = './migration/ديكوريشن العروسين.xlsx'; // Path to your Excel file
...
await Decoration.deleteMany({}); // Clear existing data

// Insert data into MongoDB
const loadData = async () => {
    try {
        await Decoration.insertMany(transformedData);
